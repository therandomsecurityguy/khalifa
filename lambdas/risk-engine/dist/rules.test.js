...
describe('riskRules', () => {
    test('should have at least 5 rules', () => {
        expect(rules_1.riskRules.length).toBeGreaterThanOrEqual(5);
    });
    test('should have exactly 10 rules', () => {
        expect(rules_1.riskRules.length).toBe(10);
    });
    test('each rule should have required fields', () => {
        for (const rule of rules_1.riskRules) {
...
describe('getEnabledRules', () => {
    test('should return only enabled rules', () => {
        const enabledRules = (0, rules_1.getEnabledRules)();
    ...
    test('should return all rules when all enabled', () => {
        const enabledRules = (0, rules_1.getEnabledRules)();
        expect(enabledRules.length).toBe(rules_1.riskRules.length);
    });
});
describe('getRuleById', () => {
    test('should return rule by valid ID', () => {
        const rule = (0, rules_1.getRuleById)('RULE-001');
        expect(rule).toBeDefined();
        expect(rule?.id).toBe('RULE-001');
    });
    test('should return undefined for invalid ID', () => {
        const rule = (0, rules_1.getRuleById)('RULE-999');
    ...
    test('should find over-privileged IAM rule', () => {
        const rule = (0, rules_1.getRuleById)('RULE-004');
    ...
    test('should find crown jewel attack path rule', () => {
        const rule = (0, rules_1.getRuleById)('RULE-005');
    ...
    test('should find cross-account IAM trust rule', () => {
        const rule = (0, rules_1.getRuleById)('RULE-006');
    ...
    test('should find public S3 bucket rule', () => {
        const rule = (0, rules_1.getRuleById)('RULE-007');
